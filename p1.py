...
cl = TOBY.LINE()
cl.login(access_token = "i7b9B49zCFtsViw5PlOsGwL/iCZQVAPQVXLo3g7eDMKmQrAeCulDRY0o1RbZSLnNRIHptHRbckTUsxVrrNQem4Gv0UUvawyNQjiKJltBw+Y1jyvQbrEjzVNa7ZCaaeO0wXiMkfTuZlwimG95NV2bsFOdY8PpfGfrsvDFhI+5nHfDTofK697pgpyqnWXJQVKW=")
cl.loginResult()
...
==================================================
PLAY BOY
SUPPORT BY : JANGAN LUPA BAHAGIA
RAPLYSAPUTRA
...
creator=["uf85670df69fb4c19ea8d9b279059a629"]
wait = {
    'contact':True,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~raplysaputra",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~paplysaputra",
    "commentOn":True,
    "commentBlack":{},
    "wblack":True,
    "dblack":True,
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line:://ti/p/~raplysaputra")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"JANGAN LUPA BAHAGIA")
						print "DiLike"
					except:
							pass
				else:
